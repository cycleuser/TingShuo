...
- **命令行 + 图形界面 + Web 界面**：完整的 CLI、tkinter GUI 和 Web 界面
- **递归扫描**：处理整个目录树中的媒体文件
...
### 图形界面 (GUI)
![GUI 截图](images/gui_screenshot.png)

### Web 界面
![Web 截图](images/web_screenshot.png)

### 命令行使用 (CLI)
![命令行转录](images/transcription_basic.svg)
